---
id: behavioral-amazon-lp
title: Amazon Leadership Principles — Behavioral Interview Guide
sidebar_label: 🏢 Amazon LP Guide
sidebar_position: 5
description: Master Amazon's 16 Leadership Principles for behavioral interviews. Includes LP definitions, question examples, and STAR story strategies for each principle.
tags:
  - Amazon
...
1. **Bar Raiser** — A senior Amazonian (from another team) attends every loop to maintain hiring bar
2. **Structured scoring** — Each interviewer owns 2–4 LPs and scores you on each
3. **Strong No Hire = No Hire** — Any single strong no-hire vote typically kills the offer
4. **Depth over breadth** — Interviewers will dig into one story with 5–10 follow-up questions

> ⚠️ **Prepare for follow-ups**: Amazon interviewers WILL probe your story. "What happened next?", "How did the manager react?", "What would you do differently?" — have full depth on every story you tell.
...
**Story strategy:** Show a specific quality bar you maintained and the impact of doing so. Avoid sounding like a perfectionist who delays — frame it as raising the bar while still delivering.
...
**Story strategy:** Show specific technical depth — the exact thing you found by digging. "I noticed that our p99 latency spiked specifically after 3PM UTC and traced it to a cron job" > "I investigated the performance issue."
...
**Story strategy:** This LP tests BOTH sides: (1) that you raised your concern with data and professionalism, AND (2) that you executed fully once the decision was made — even if you disagreed.
...
**Story strategy:** Use strong, quantified results. Emphasize the obstacles specifically — what would have stopped a lesser person? And show you took responsibility for the outcome.
...
| Priority | LP | Why |
|----------|-----|-----|
| 🔴 Must-have | Ownership | Asked in almost every loop |
| 🔴 Must-have | Customer Obsession | Amazon's #1 principle |
| 🔴 Must-have | Deliver Results | Core execution metric |
| 🔴 Must-have | Bias for Action | Speed is core to Amazon culture |
| 🔴 Must-have | Dive Deep | Especially for senior engineers |
| 🟡 Important | Have Backbone; Disagree and Commit | Distinguishes senior+ candidates |
| 🟡 Important | Invent and Simplify | Innovation signals |
| 🟡 Important | Insist on the Highest Standards | Quality signals |
| 🟢 Secondary | Earn Trust | Shows interpersonal maturity |
| 🟢 Secondary | Learn and Be Curious | Shows growth mindset |

---

## Amazon Interview Day Tips

1. **Know all 16 LPs by heart** — at minimum, be able to name them
2. **Prepare 2 stories per priority LP** (in case they ask for another example)
3. **Expect follow-up drills** — "What was the exact metric?" / "What did your manager say?"
4. **Use "I" aggressively** — Amazon scores individuals, not teams
5. **Bring numbers to every result** — Amazon is deeply data-driven
6. **Don't exaggerate** — Bar raisers have heard thousands of stories and can tell
