    ...
    routes: [
      {
        ...
        routes: [
          ...
          {
            path: '/',
            component: ComponentCreator('/', 'd43'),
            routes: [
              {
                path: '/aws',
              ...
              },
              {
                ...
                component: ComponentCreator('/technical-knowledge/kafka/advanced/exactly-once-vs-dedup', 'b5e'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/technical-knowledge/kafka/advanced/kafka-streams-deep-dive', '442'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/technical-knowledge/kafka/advanced/kafka-throughput-optimization',
                component: ComponentCreator('/technical-knowledge/kafka/advanced/kafka-throughput-optimization', '7d0'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/technical-knowledge/kafka/core/kafka-broker', '19d'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
