    ...
    <div className="interactive-diagram-container" style={{ fontFamily: 'var(--ifm-font-family-base)' }}>
      <div className="interactive-diagram-header">
        ...
        <span style={{ color: 'var(--ifm-color-content)', fontWeight: 700 }}>
          Kafka Cluster Architecture: Topics, Partitions & Brokers
        </span>
      </div>
      <div style={{ padding: '16px' }}>
        ...
        <div style={{ backgroundColor: '#0c0e17', padding: '14px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.08)' }}>
          {activeTab === 'overview' ? (
            <p style={{ margin: 0, fontSize: '12px', color: '#38bdf8' }}>Interactive visualization of kafka cluster architecture: topics, partitions & brokers. Guarantees high-throughput event streaming with zero-copy I/O.</p>
          ) : (
