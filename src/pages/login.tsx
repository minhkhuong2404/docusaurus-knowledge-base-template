...
export default function Login(): React.ReactNode {
  ...
  const [returnTo, setReturnTo] = useState('/premium/intro');
  const location = useLocation();

  useEffect(() => {
    // Extract the returnTo parameter if present (e.g., ?returnTo=/premium/advanced-guide)
      ...
      <Layout title="Dashboard">
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', padding: '1rem' }}>
          <div style={{ padding: '2.5rem', border: '1px solid var(--ifm-color-success-dark)', borderRadius: '12px', maxWidth: '400px', width: '100%', textAlign: 'center', backgroundColor: 'var(--ifm-background-surface-color)' }}>
            ...
            <a href="/premium/intro" className="button button--primary button--block" style={{ marginBottom: '1rem' }}>Browse Premium Content</a>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <input
                ...
                placeholder="Enter Premium Content pass code"
                required
              />
            </div>
